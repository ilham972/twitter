...
async function loadFakeData(numUsers: number = 10) {
  // this 10 for safety you can now remove this
  console.log(`executing load fake data. ${numUsers} users. `);
...
loadFakeData(numUsers); // don't you can remov numUsers here bcz i set default value 10 in function
